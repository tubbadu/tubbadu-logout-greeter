...
QT_MOC_LITERAL(1, 8, 23), // "introductionTextChanged"
QT_MOC_LITERAL(2, 32, 0), // ""
QT_MOC_LITERAL(3, 33, 16) // "introductionText"

    },
    "Process\0introductionTextChanged\0\0"
    "introductionText"
};
...
void Process::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->introductionTextChanged(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Process::introductionTextChanged)) {
                *result = 0;
                return;
            }
        }
        ...
        void *_v = _a[0];
        switch (_id) {
        case 0: *reinterpret_cast< QString*>(_v) = _t->introductionText(); break;
        default: break;
        }
        ...
        void *_v = _a[0];
        switch (_id) {
        case 0: _t->setIntroductionText(*reinterpret_cast< QString*>(_v)); break;
        default: break;
        }
...
// SIGNAL 0
void Process::introductionTextChanged()
{
